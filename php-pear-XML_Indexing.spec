...
install -d %{buildroot}%{_datadir}/pear/%{_class}/%{_subclass}/Builder

install %{_pearname}-%{version}/%{_subclass}/*.php %{buildroot}%{_datadir}/pear/%{_class}/%{_subclass}
install %{_pearname}-%{version}/%{_subclass}/Builder/*.php %{buildroot}%{_datadir}/pear/%{_class}/%{_subclass}/Builder
